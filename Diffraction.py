...
im1 = axes[0,1].imshow(y1_tile,cmap=color_map,extent=[-500,500,0,200],origin='lower')
colorbar1 = fig.colorbar(im1,ax=axes[0,1],label='I (W/m^2)')
axes[0,1].set_title('The whole screen')
axes[0,1].set_xlabel('Position')

im1 = axes[0,2].imshow(y1_slice,cmap=color_map,extent=[-50,50,0,20],origin='lower')
...
im2 = axes[1,1].imshow(y2_tile,cmap=color_map,extent=[-5000,5000,0,2000],origin='lower')
colorbar2 = fig.colorbar(im2,ax=axes[1,1],label='I (W/m^2)')
axes[1,1].set_title('The whole screen')
axes[1,1].set_xlabel('Position')

im2 = axes[1,2].imshow(y2_slice,cmap=color_map,extent=[-500,500,0,200],origin='lower')
...
im3 = axes[2,1].imshow(y3_tile,cmap=color_map,extent=[-50000,50000,0,20000],origin='lower')
colorbar3 = fig.colorbar(im3,ax=axes[2,1],label='I (W/m^2)')
axes[2,1].set_title('The whole screen')
axes[2,1].set_xlabel('Position')

im3 = axes[2,2].imshow(y3_slice,cmap=color_map,extent=[-5000,5000,0,2000],origin='lower')
